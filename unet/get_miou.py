...
if __name__ == "__main__":
    ...
    #--------------------------------------------#
    name_classes    = ["background","leaf", "gland", "bird", "boat", "bottle", "bus", "car", "cat", "chair", "cow", "diningtable", "dog", "horse", "motorbike", "person", "pottedplant", "sheep", "sofa", "train", "tvmonitor"]
